...
/**
 * Returns true if at least one element in the input array is an array
 */
function hasArray(argsArr) {
  return argsArr.reduce((prev, curr) => prev || Array.isArray(curr), false);
}

module.exports = { getPattern, hasArray };
